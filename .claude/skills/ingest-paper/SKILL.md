...
Step 2(본문 추출)는 CLAUDE.md 의 `pypdf` 스니펫을 그대로 쓴다. 첫 ~30페이지, ~40,000자를 뽑는다. 방법론만이 아니라 실험 세부와 ablation까지 sources에 담기 위한 상한이다 (과거의 12,000자 상한은 wiki 상세도 부족의 상류 원인이었다).
