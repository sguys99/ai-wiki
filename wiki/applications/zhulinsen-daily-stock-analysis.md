...
A주·홍콩·미국·일본·한국·대만 6개 시장 종목을 매일 자동 분석해 매수/관망/매도 점수를 매긴다. 결과는 텔레그램·디스코드·슬랙 등으로 리포트를 push하는 오픈소스 AI 주식 분석 시스템이다. Python 3.10+ 기반이며 MIT 라이선스로 배포된다.
...
- [[agents/cemri-2025-why-do-multi-agent-llm-systems]] — 멀티에이전트 시스템의 신뢰성 실패 패턴을 다룬 연구. 본 저장소의 "실험적" 멀티에이전트 전략 채팅을 평가할 때 참고할 만한 반대편 관점.
