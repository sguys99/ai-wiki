...
- 생성: 2025-04-16 · star 약 122 (수집 시점)
- 라이선스: 명시 없음
...
- [[physical-ai/cui-2025-openhelix-a-short-survey-empirical]] — 이 저장소의 판정 기준과 구조 분류가 전부 여기서 온다. 논문이 Table 1로 고정해 둔 6종 비교를 저장소가 계속 자라는 목록으로 넓혔다
- [[physical-ai/black-2024-pi0-a-vision-language-action-flow-model]] — 배제 목록 쪽. System 1이 실시간 perception을 안 받는다는 이유다
- [[physical-ai/black-2025-pi05-a-vision-language-action-model-with]] — 같은 이유로 배제 목록
- [[physical-ai/nvidia-2025-gr00t-n1-an-open-foundation]] — humanoid 배제 목록이자 LIBERO 결과표의 single-system 행
- [[physical-ai/figure-ai-2025-helix-a-vision-language-action]] — humanoid 절의 유일한 항목. 논문이 없어 발표처와 날짜가 비어 있다
- [[physical-ai/kim-2024-openvla-an-open-source-vision-language-action-model]] — 두 결과표 모두에서 single-system 기준선
- [[physical-ai/keon-awesome-physical-ai]] · [[physical-ai/natnew-awesome-physical-ai]] — 같은 성격의 큐레이션 저장소. 두 곳은 physical AI 전반을 넓게 훑는 데 반해 여기는 dual-system 하나로 좁고 대신 판정을 내린다
- [[overviews/glossary-physical-ai]] — dual-system VLA 표기와 판정 기준
