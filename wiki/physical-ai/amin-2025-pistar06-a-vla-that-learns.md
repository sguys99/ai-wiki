...
상자 조립은 다르게 움직인다. 장기 과제라 첫 반복에서는 throughput이 오히려 하락했다가 두 번째 반복에서 두 배로 오른다. 저자들은 긴 과제일수록 유의미한 개선에 더 많은 데이터가 필요하다고 해석한다. 성공률은 두 반복 내내 계속 올라 최종적으로 접기와 라벨 단계 모두 600초 제한 안에서 90% 수준에 닿는다.
