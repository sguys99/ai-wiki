...
성공률만 놓고 보면 asynchronous 쪽이 5.0%p 낮아 항상 더 좋다고 말하기 어렵다. 반면 완료 시간은 4.05초 줄고, 정해진 시간 안에 pick-and-place에 성공한 cube 수는 9개에서 19개로 2배 이상 늘어난다. 성공률의 5.0%p 차이보다 단위 시간당 throughput의 차이가 훨씬 크다. throughput은 정해진 시간 안에 끝낸 과제 수를 뜻한다.
