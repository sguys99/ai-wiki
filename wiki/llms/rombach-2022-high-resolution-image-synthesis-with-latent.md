...
| VQ-reg | 디코더 안에 벡터 양자화 층을 두고 codebook을 학습한다 | VQGAN(양자화 층을 디코더가 흡수한 형태) | codebook 차원을 크게 잡아 정규화를 약하게 한다. diffusion 학습에는 양자화 이전의 z를 쓰고 양자화 연산은 디코더의 첫 층으로 본다 |
...
| f | 정규화와 codebook | c | R-FID | R-IS | PSNR | PSIM | SSIM |
|---|---|---|---|---|---|---|---|
...
| codebook 크기 | - | 2048 | 8192 | 16384 | 16384 | 16384 |
...
| codebook 크기 | - | 8192 | 16384 | 8192 | 8192 | 8192 | 16384 |
