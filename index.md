...
- [[applications/cheahjs-free-llm-api-resources|cheahjs/free-llm-api-resources (repo)]] — 무료 또는 체험 크레딧으로 쓰는 LLM API 서비스 26곳을 모아 모델·요청/토큰 한도·데이터 정책을 표로 정리한 커뮤니티 큐레이션 레포 (2026, repo)
...
- [[overviews/physical-ai-overview|Physical AI — 분류 뼈대와 학습 경로]] — 자료가 들어오기 전에 physical-ai 카테고리의 분류 기준·통제 태그 어휘·읽는 순서를 먼저 세워 둔 허브. 저장소에 physical AI 자료가 0건이라는 사실을 그대로 적고, 지금 링크 가능한 인접 페이지(VLM3·TaskMem)만으로 학습 경로 두 단계를 깔았다 (2026, overview)
