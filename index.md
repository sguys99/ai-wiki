...
- [[llms/lipman-2022-flow-matching-for-generative-modeling|Flow Matching]]: CNF를 ODE 시뮬레이션 없이 학습하는 목표. 조건부 vector field 회귀가 원 목표와 gradient가 같고 diffusion을 특수 사례로 포함하며 OT 직선 경로로 샘플링이 빨라진다 (2022, paper)
