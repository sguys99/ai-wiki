...
> 수집 메모 — 사용자의 명시적 URL 지시에 따라 `raw.githubusercontent.com/strands-labs/robots/main/README.md` 를 그대로 받아 저장했다 (CLAUDE.md rule #1 의 자료 수집 예외). 본문은 원문 그대로이며 요약, 번역, 윤문하지 않았다. 수집 시각 2026-09-09. 저장소 생성 2026-02-19, 최종 push 2026-09-08, star 155, PyPI 패키지 `strands-robots`.
