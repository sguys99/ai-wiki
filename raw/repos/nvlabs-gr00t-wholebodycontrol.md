...
> 수집 메모 — 사용자의 명시적 URL 지시에 따라 `raw.githubusercontent.com/NVlabs/GR00T-WholeBodyControl/main/README.md` 를 그대로 받아 저장했다 (CLAUDE.md rule #1 의 자료 수집 예외). 본문은 원문 그대로이며 요약·번역·윤문하지 않았다. 수집 시각 2026-08-03.
