...
subtitle: "Karpathy's compounding wiki, Garry Tan's autonomous brain, and the decision framework most teams skip"
type: article
year: 2026
...
reading_time: "15 min"
stats: "1.3K claps, 9 responses (수집 시점)"
tags: [rag, llm-wiki, gbrain, karpathy, garry-tan, fat-skills, agent-memory, decision-framework, context-window, chunking, compounding, autonomy, hybrid-architecture, claude-code]
---

> 본 raw 파일은 사용자가 수동으로 본문을 복사·저장한 것이다 (CLAUDE.md의 articles 기본 워크플로우). 원본 URL은 frontmatter `url` 참조. 본문은 원작자(Yanli Liu)의 저작물이며 본 ai-wiki는 비공개 개인 지식 베이스 목적으로 인용한다.
...
**Yanli Liu** · 15 min read · Apr 27, 2026 · 1.3K claps · 9 responses
