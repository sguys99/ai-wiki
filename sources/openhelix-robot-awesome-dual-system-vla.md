...
OpenHelix 저자들이 자기 논문의 서베이 절을 살아 있는 목록으로 옮긴 awesome 리스트다. "이건 dual-system이 아니다"라는 배제 목록을 나란히 둔 것이 특징이다. π0, π0.5, GR00T N1 같은 유명 모델이 배제 목록에 들어가 있다.
...
라이선스가 명시돼 있지 않다. 목록 자체는 공개 정보의 정리지만 인용과 재배포 조건이 불분명하다.
...
- **LIBERO Spatial / Object / Goal / Long**: LIBERO 벤치마크의 네 과제군. 각각 공간 배치 변화, 물체 변화, 목표 변화, long-horizon 과제에 대한 일반화를 잰다.
